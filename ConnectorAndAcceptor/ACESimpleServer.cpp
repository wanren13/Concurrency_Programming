...
class SimpleServerHandler : public ACE_Svc_Handler < ACE_SOCK_STREAM, ACE_NULL_SYNCH > {
public:
...
class SimpleAcceptor : public ACE_Acceptor < SimpleServerHandler, ACE_SOCK_ACCEPTOR > {
public:
	SimpleAcceptor() :ACE_Acceptor<SimpleServerHandler, ACE_SOCK_ACCEPTOR>(ACE_INET_Addr(1234, ACE_LOCALHOST), ACE_Reactor::instance()){}
};
